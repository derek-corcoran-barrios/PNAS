...
\dropcap{T}his PNAS journal template is provided to help you write your work in the correct journal format. Instructions for use are provided below. \cite{Alizon2009-no}
...
\subsection*{References}
 ...
 All references cited in the main text should be included in the main manuscript file.
